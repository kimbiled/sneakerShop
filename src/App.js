  ...
  return (
    <div className='wrapper clear'>
      ...
      <div className='d-flex align-center '>
        <img src='/img/logo.png' alt='logo' width={40} height={40} className="mg"/>
        ...
        <ul className='d-flex'>
          ...
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="mr-15">
      ...
      <div className="card">
          <img src="/img/sneakers/1.jpg" alt="sneaker" width={133} height={112}/>
        ...
        <div className="card">
          <img src="/img/sneakers/2.jpg" alt="sneaker" width={133} height={112}/>
        ...
        <div className="card">
          <img src="/img/sneakers/3.jpg" alt="sneaker" width={133} height={112}/>
          <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
          <div className="d-flex justify-between align-center">
             <div className="d-flex flex-column">
              <span>Цена: </span>
        ...
        <div className="card">
          <img src="/img/sneakers/4.jpg" alt="sneaker" width={133} height={112}/>
